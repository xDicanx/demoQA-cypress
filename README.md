...
- **Setup:**  
  Requires Docker. Detailed instructions can be found in the [`api-tests/README.md`]([./api-tests/README.md](https://github.com/xDicanx/demoQA-cypress/blob/main/cypress/e2e/API%20testing/README.md)).  
